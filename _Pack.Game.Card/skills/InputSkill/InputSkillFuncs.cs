...
namespace Pack
{
    ...
    public abstract partial class InputSkill//static function set
    {
        ...
        {
            //writting
            s.F_AfterWrite_GetNext.Add(new AfterWrite_GetNext_LineNode());

            // test
            s.F_HighLightTest.Add(new HighLightTest_ManaEnough());
            s.F_TestNodeUseful.Add(new TestNodeUseful_In_Range())
        ...
        public static void EnableReach(InputSkill_Delegate s, object o)
        {
            ...
            s.F_GetFloat.Add(new GetFloat_Reach()).Set(NN.Reach, to);
        }
        public static void EnableThrowLine(InputSkill_Delegate s, object HighThrow, IGet<N<int>> speed)
        {
            ...
            s.F_GetBool.Add(new GetBool_IsHighThrow()).Set(NN.HighThrow, HighThrow);
            s.F_GetInt.Add(new GetInt_Speed()).Set(NN.speed, speed);
        }
        public static void EnableThrowOffset(InputSkill_Delegate s, IGet<N<float>> OffsetY, IGet<N<float>> OffsetXZ)
        {
            s.F_GetFloat.Add(new GetFloat_Offset())
